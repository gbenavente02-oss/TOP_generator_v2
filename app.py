...
if to_file and cc_file:
    if st.button('Procesar Datos'):
        with st.spinner('Procesando escenarios y cruzando pestañas...'):
            ...
            df_top_full['Paño'] = df_top_full['Paño'].str.replace('AT', 'Respaldo TR').str.replace('HT', 'Respaldo TR')
            ...
            def custom_sort_key(col):
                ...
                elif pano.startswith(('ET', 'CT')): grupo = 2
            ...
            for escenario in escenarios:
                ...
                for i, barra_col in enumerate(barras_cols):
                    ...
                    pano_et = next((p for p in feeder_cols.keys() if p.startswith(('ET', 'CT'))), None)
